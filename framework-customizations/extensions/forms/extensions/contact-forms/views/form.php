...
$fields_style = !empty($extra_data['fields_style']) ? $extra_data['fields_style'] : '';
?>
<div class="form-wrapper <?php echo esc_attr( $extra_data['background_color'] . ' '. $extra_data['field_text_align'] .' '. $fields_style .' ' . $extra_data['columns_padding'] ); ?>">
